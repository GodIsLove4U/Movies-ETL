{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Try and except statement for opening the file\n",
    "try:\n",
    "    \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Create a function to take in 3 arguments\n",
    "def manage_movies (kaggle, ratings, wiki):\n",
    "    kaggle_metadata = kaggle\n",
    "    ratings = ratings\n",
    "    wiki = wiki_movies_df   "
   ]
  },
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<matplotlib.axes._subplots.AxesSubplot at 0x180035e01c8>"
      ]
     },
     "execution_count": 52,
     "metadata": {},
  ...
  },
  {
   ...
   "source": [
    ...
    "    print('Code has already been run')\n",
    "\n",
    "except: \n",
    "    print('Check login, timing and other sql functions')"
   ]
  },
  {
   "cell_type": "code",
